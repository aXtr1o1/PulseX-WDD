...
export default function OverlayMenu({ open, onClose }: OverlayMenuProps) {
    ...
    const links = [
        ...
        { label: 'Lead Intelligence Dashboard', href: '/admin' },
        { label: 'Data Sources (Verified Intelligence)', href: '/sources' },
        { label: 'Retrieval Quality / System Health', href: '/quality' },
    ];
    ...
    return (
        ...
        >
            ...
            <button
                onClick={onClose}
                className="absolute top-6 right-6 w-10 h-10 flex items-center justify-center rounded-full hover:bg-[var(--wdd-surface)] text-[var(--wdd-icon-grey)] transition-colors z-[91]"
            >
